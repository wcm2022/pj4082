...
\vspace{6em} %下移
\fontsize{30pt}{1pt}\selectfont\textbf{3d 列印機電模擬系統在 uArm 機械手臂設計流程上的應用}\\
\vspace{1em}
\sectionef\fontsize{30pt}{1em}\selectfont\textbf
{
\vspace{0.5em}
The Application of 3D Printing Mechatronic Simulation System
 \vspace{0.5em} 
 in the Design Process of uArm Robotic Arm}
 \vspace{2em}
%=---------------------參與人員-----------------------=%             
\end{center}
\begin{flushleft}
