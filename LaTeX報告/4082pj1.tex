...
\vspace{6em} %下移
\fontsize{30pt}{1pt}\selectfont\textbf{3D 列印模擬系統在機械手臂設計上的應用}\\
\vspace{1em}
\sectionef\fontsize{30pt}{1em}\selectfont\textbf
{
\vspace{0.5em}
Application of 3D Printing Simulation System in Robot Arm Design}
 \vspace{2em}
%=---------------------參與人員-----------------------=%             
\end{center}
\begin{flushleft}
...
%=---------------專題製作合可證明---------------------=%
 ...
 {\begin{center}
    ...
    \noindent \fontsize{16pt}{16pt}\selectfont 專題製作題目\enspace ：3D 列印模擬系統在機械手臂設計上的應用
    \hspace*{\fill} \\
    \hspace*{\fill} \\
...
%=-------------作者簡介-----------------=%
	...
	\begin{figure}
	\includegraphics[width=1.25in]{dragon} 
	\end{figure}
	\end{textblock}}
   ...
   \vspace{2em}
	...
	\begin{figure}
	\includegraphics[width=1.15in]{dragon} 
    \end{figure}
    \end{textblock}}
...
\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{經歷}\enspace:\enspace
    ...
    \begin{figure}
        \includegraphics[width=1.15in]{dragon} %{}內是圖片文件的相對路徑
    \end{figure}
    \end{textblock}}
    {\renewcommand\baselinestretch{0.99}\selectfont %設定以下行距
